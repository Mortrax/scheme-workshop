...
;; TASK: Define a procedure called 'summation' that takes in two positive integers
;; 'i' and 'n', and returns the sum of all integers from i to n, including i and n
;; This represents the summation notation (sigma notation) that you may remember from
;; a course in discrete mathematics

;; HINT: You will need to define this procedure recursively (e.g. summation should call itself)
;; Think about what your base case will be (e.g. is there a condition on the values of i and n
;; for which there is no meaningful sum of numbers from i to n? If so, what default value
;; should we return to handle this condition?
;; Think about value you need to return from the function in both 
;; the base case and recursive case

;; TO BE COMPLETED BY YOU
(define summation (lambda (i n) ...))
