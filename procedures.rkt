...
;; TASK define a procedure called 'product-of-five' that takes in five numbers, and
;; returns a number that is the product of those numbers

;;; TO BE COMPLETED BY YOU

(define product-of-five (lambda ...))
